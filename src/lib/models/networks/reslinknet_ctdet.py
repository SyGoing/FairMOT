...
class ReLinkNet(nn.Module):
    ...
    def __init__(self,num_layers, heads, head_conv,is_train):
        ...
        if num_layers==18:
            ...
            base=resnet.resnet34(pretrained=False)
        elif num_layers==50:
        ...
        self.decoder2 = Decoder(128, 64, 4, 2, 1, 0)
        self.decoder3 = Decoder(256, 128, 4, 2, 1, 0)
        self.decoder4 = Decoder(512, 256, 4, 2, 1, 0)
        ...
        # update now test lab
        # self.decoder1 = conv_bn(64,64,1)
        # self.decoder2 = Decoder(128, 64, 2, 2, 0, 0)
        # self.decoder3 = Decoder(256, 128, 2, 2, 0, 0)
        # self.decoder4 = Decoder(512, 256, 2, 2, 0, 0)
